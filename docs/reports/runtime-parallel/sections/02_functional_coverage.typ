...
#figure(
  table(
    ...
    table.cell(rowspan: 10)[`ParallelForDynamic`],
                                            [`ParallelForDynamic_AllIterationsExecute`],
                                            [`ParallelForDynamic_CorrectValues`],
                                            [`ParallelForDynamic_ChunkSizeOne`],
                                            [`ParallelForDynamic_ChunkSizeLargerThanIterations`],
                                            [`ParallelForDynamic_ZeroIterations`],
                                            [`ParallelForDynamic_NegativeIterations`],
                                            [`ParallelForDynamic_InvalidChunkSize`],
                                            [`ParallelForDynamic_WithClampedPoolSize`],
                                            [`ParallelForDynamic_DistributesAcrossGoroutines`],
                                            [`ParallelForDynamic_StressNoRace`],

    table.cell(rowspan: 3)[`ForStaticChunked`],
                                            [`ForStaticChunked_RoundRobinDistribution`],
                                            [`ForStaticChunked_StandaloneSequential`],
                                            [`ForStaticChunked_InvalidChunkDefaultsToOne`],

    table.cell(rowspan: 2)[`ParallelForStaticChunked`],
                                            [`ParallelForStaticChunked_AllIterationsOnce`],
                                            [`ParallelForStaticChunked_ZeroIterations`],

    table.cell(rowspan: 5)[`ParallelSections`],
                                            [`ParallelSections_AllSectionsExecute`],
                                            [`ParallelSections_FewerSectionsThanThreads`],
                                            [`ParallelSections_MoreSectionsThanThreads`],
                                            [`ParallelSections_WithClampedPoolSize`],
                                            [`ParallelSections_DifferentBodies`],
