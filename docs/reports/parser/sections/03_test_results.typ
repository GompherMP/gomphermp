...
#figure(
  table(
    ...
    [Parseo de directivas],                 [41],         [Verifican la construcción de cada tipo de directiva con sus combinaciones de cláusulas mediante `parseDirectiveText`.],
