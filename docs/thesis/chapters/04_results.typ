...
Para alcanzar este resultado, la selección de las directivas y cláusulas se realizó mediante un análisis técnico enfocado en cubrir los dos paradigmas principales del estándar OpenMP (versión 5.2): el paralelismo estructurado y el paralelismo basado en tareas. En lugar de intentar abarcar la totalidad del estándar, se aplicó un criterio de delimitación de alcance (_scoping_) apropiado para la magnitud del proyecto. Se priorizaron los constructos fundamentales que resultan críticos para demostrar la viabilidad técnica de la traducción y paralelización de código hacia Go, garantizando que el subconjunto elegido sea altamente representativo para aplicaciones concurrentes de propósito general.
