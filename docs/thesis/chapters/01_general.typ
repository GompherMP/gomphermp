...
#figure(
  ...
  - El código implementa la gestión del pool de goroutines y el reparto de iteraciones para las directivas parallel, for, parallel for sections y schedule.
